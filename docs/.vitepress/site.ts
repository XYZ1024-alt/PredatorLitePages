 ...
 *
 * Left empty on purpose: the existing `main.png` is a 584x831 portrait
 * screenshot and would be badly cropped by social cards. Add a dedicated
 * 1200x630 image to `docs/public/img/` and point this at it. While empty,
 * `og:image` is omitted and the Twitter card stays `summary`.
 */
